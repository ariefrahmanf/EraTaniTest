...
import com.ariefrahmanfajri.dataprocessapp.databinding.FragmentSellerProductStockBinding
import com.ariefrahmanfajri.dataprocessapp.presentation.adapter.ProductListAdapter
import org.koin.androidx.viewmodel.ext.android.viewModel

class SellerProductStockFragment : Fragment() {
    private var _binding: FragmentSellerProductStockBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSellerProductStockBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
