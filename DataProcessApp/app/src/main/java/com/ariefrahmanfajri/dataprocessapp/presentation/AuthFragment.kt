...
import com.ariefrahmanfajri.dataprocessapp.databinding.FragmentAuthBinding
...
class AuthFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnSellerLogin.setOnClickListener {
            nav?.navigate(AuthFragmentDirections.actionAuthFragmentToSellerHomeFragment())
        }

        binding.btnBuyerLogin.setOnClickListener {
            nav?.navigate(AuthFragmentDirections.actionAuthFragmentToHomeFragment2())
        }
